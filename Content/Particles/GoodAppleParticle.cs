...
{
    public class GoodAppleParticle : Particle
    {
        public int FallOverDirection;

        public bool HasHitGround;

        public override string AtlasTextureName => "NoxusBoss.GoodAppleParticle.png";

        public GoodAppleParticle(Vector2 position, Vector2 velocity, Color color, int lifetime, float scale)
        {
            Position = position;
            Velocity = velocity;
            DrawColor = color;
        ...
        public override void Update()
        {
            ...
            // Move.
            Velocity.Y += 0.3f;
            Velocity = Collision.TileCollision(Position - Vector2.One * Scale * 11f, Velocity, (int)(Scale.X * 22f), (int)(Scale.Y * 22f));
            ...
            else
            {
                ...
                float fallOverSpeed = Utils.Remap(Abs(Rotation), 0.1f, 0.6f, 0.04f, 0.12f);

...
{
    public class Starburst : ModProjectile, IDrawGroupedPrimitives, IProjOwnedByBoss<NamelessDeityBoss>
    {
        public PrimitiveTrailInstance TrailDrawer
        {
            get;
            private set;
        }
        ...
        public ManagedShader Shader => ShaderManager.GetShader("GenericFlameTrail");
        ...
        public override void SetDefaults()
        {
            ...
            TrailDrawer = (this as IDrawGroupedPrimitives).GenerateInstance(Projectile);
        }
        ...
        public override void AI()
        {
            ...
            if (Redirect && Time >= 65f)
            {
                ...
                Vector2 idealDirection = Projectile.DirectionToSafe(target.Center);
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            if (!Big)
            {
                TrailDrawer.PrimitiveDrawer ??= new(FlameTrailWidthFunction, FlameTrailColorFunction, null, true, Shader);
                TrailDrawer.UpdateBuffers(Projectile.oldPos.Take(6).ToArray(), Projectile.Size * 0.5f - Main.screenPosition, 5);
            }

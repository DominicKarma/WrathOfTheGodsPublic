...
namespace NoxusBoss.Content.NPCs.Bosses.NamelessDeity.Projectiles
{
	public class ExplodingStar : ModProjectile, IDrawsWithShader, IProjOwnedByBoss<NamelessDeityBoss>
	{
		...
		public override void OnKill(int timeLeft)
		{
			...
			if (Main.netMode != NetmodeID.MultiplayerClient)
			{
				...
				for (int i = 0; i < starburstCount; i++)
				{
					...
					NewProjectileBetter(Projectile.GetSource_FromThis(), Projectile.Center, starburstVelocity, starburstID, NamelessDeityBoss.StarburstDamage, 0f, -1);
				}
			}
		}
		...
		public void DrawWithShader(SpriteBatch spriteBatch)
		{
			...
			var fireballShader = ShaderManager.GetShader("NoxusBoss.FireExplosionShader");

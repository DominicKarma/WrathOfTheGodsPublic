...
float4 PixelShaderFunction(float2 coords : TEXCOORD0) : COLOR0
{
    ...
    float2 sphereCoords = coords * spherePinchFactor + float2(globalTime * 0.9, 0);
    ...
    result -= subtractiveAccentFactor * tex2D(accentNoiseTexture, sphereCoords * 2).r * 1.1;
    ...
    return starOpacity * float4(result, 1) + float4(mainColor, 1) * coronaBrightness;
}

...
float4 PixelShaderFunction(float4 sampleColor : COLOR0, float2 coords : TEXCOORD0) : COLOR0
{
    ...
    float portalDistance = lerp(tex2D(fadeoutDistanceLookupTexture, float2(coords.x, 1 - coords.y) + uvOffset * distanceIrregularity * 4) * circleStretchInterpolant * 0.11, 0.3, pow(circleStretchInterpolant, 7.3) - distanceIrregularity);

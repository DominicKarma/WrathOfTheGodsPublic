...
namespace NoxusBoss.Core.Graphics.Shaders
{
    public class ShaderManager : ModSystem
    {
        ...
        public override void OnModLoad()
        {
            ...
            Ref<Effect> s = new(Mod.Assets.Request<Effect>("Assets/Effects/ScreenDistortions/LocalizedDistortionShader", AssetRequestMode.ImmediateLoad).Value);
            ...
            Ref<Effect> s2 = new(Mod.Assets.Request<Effect>("Assets/Effects/ScreenDistortions/NamelessDeityScreenTearShader", AssetRequestMode.ImmediateLoad).Value);
            ...
            Ref<Effect> s3 = new(Mod.Assets.Request<Effect>("Assets/Effects/ScreenDistortions/RadialScreenShoveShader", AssetRequestMode.ImmediateLoad).Value);
            ...
            Ref<Effect> s4 = new(Mod.Assets.Request<Effect>("Assets/Effects/ScreenDistortions/ScreenSplitShader", AssetRequestMode.ImmediateLoad).Value);
            ...
            Ref<Effect> s5 = new(Mod.Assets.Request<Effect>("Assets/Effects/OverlayModifiers/NamelessDeityClockDeathZoneShader", AssetRequestMode.ImmediateLoad).Value);
            ...
            Ref<Effect> s6 = new(Mod.Assets.Request<Effect>("Assets/Effects/Objects/SpreadTelegraphInvertedShader", AssetRequestMode.ImmediateLoad).Value);
            ...
            Ref<Effect> s7 = new(Mod.Assets.Request<Effect>("Assets/Effects/OverlayModifiers/TerminusScreenOverlayShader", AssetRequestMode.ImmediateLoad).Value);
            ...
            Ref<Effect> s8 = new(Mod.Assets.Request<Effect>("Assets/Effects/OverlayModifiers/MainMenuScreenShakeShader", AssetRequestMode.ImmediateLoad).Value);
            ...
            Ref<Effect> s9 = new(Mod.Assets.Request<Effect>("Assets/Effects/OverlayModifiers/HighContrastScreenShader", AssetRequestMode.ImmediateLoad).Value);
            ...
            Ref<Effect> s10 = new(Mod.Assets.Request<Effect>("Assets/Effects/ScreenDistortions/GravitationalLensingShader", AssetRequestMode.ImmediateLoad).Value);
            Ref<Effect> s11 = new(Mod.Assets.Request<Effect>("Assets/Effects/ScreenDistortions/GravitationalLensingShader", AssetRequestMode.ImmediateLoad).Value);
            ...
            Ref<Effect> s12 = new(Mod.Assets.Request<Effect>("Assets/Effects/ScreenDistortions/LightSlashesOverlayShader", AssetRequestMode.ImmediateLoad).Value);

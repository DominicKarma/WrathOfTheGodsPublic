...
{
    // NOTE: Yes, this is basically completely equivalent to Calamity's modern metaball system. I wrote it for them.
    // It is based on an old system this mod used to use.
